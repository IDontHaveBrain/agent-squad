...
export const metadata: Metadata = {
  title: "Agent Squad - Manage Multiple AI Code Assistants",
  ...
  keywords: ["agent", "agent squad", "ai", "code assistant", "terminal", "tmux", "claude code", "codex", "aider"],
  authors: [{ name: "IDontHaveBrain" }],
  openGraph: {
    title: "Agent Squad",
    description: "A terminal app that manages multiple AI code assistants in separate workspaces",
    url: "https://github.com/IDontHaveBrain/agent-squad",
    type: "website",
  },
  twitter: {
